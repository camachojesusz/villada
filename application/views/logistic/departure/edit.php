...
<section class="seccion">
   ...
   <div class="col-xs-10">
      <section class="content-header">
         <h1>Salidas <small>Editar Salida <b><?php echo $departure->row()->sheet_departure; ?></b></small></h1>
         <ol class="breadcrumb">
                  ...
                  <div class="box-body row">
                     <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                           ...
                           <input class="form-control" type="hidden" id="departure_id" name="departure_id" value="<?php echo $departure->row()->departure_id; ?>">
                           <input class="form-control" type="hidden" id="sheet_departure" name="sheet_departure" value="<?php echo $departure->row()->sheet_departure; ?>">
                           <input class="form-control" type="date" id="txtplan_date" name="txtplan_date" value="<?php echo $departure->row()->plan_date; ?>">
                        </div>
                     </div>
                     <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                           <label for=""><sup><li class="fa fa-asterisk color-asterisk-required"></li></sup>Destino</label><br>
                           <?php echo form_dropdown('txtdestiny_id', $dy, set_value('txtdestiny_id', $departure->row()->destiny_id), 'class="form-control select2" weight="100%"'); ?>
                        </div>
                     </div>
                     <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                           <label for=""><sup><li class="fa fa-asterisk color-asterisk-required"></li></sup>Vehículo</label><br>
                           <?php echo form_dropdown('txtvehicle_id', $ve, set_value('txtvehicle_id', $departure->row()->vehicle_id), 'class="form-control select2" weight="100%"'); ?>
                        </div>
                     </div>
                     <div class="col-xs-12 col-md-6">
                        ...
                        <div class="input-group">
                           <label for="txt_ctrl_driver_a" class="input-group-addon" title="Conductor">
                              <input type="radio" id="txt_ctrl_driver_a" name="txt_ctrl_driver" value="0" required <?php if($departure->row()->driver_type === '0'){ echo "checked"; $_activate = ''; } else { $_activate = ' disabled'; } ?>>
                              <i class="fa fa-user"></i>
                           </label>
                           <?php echo form_dropdown('txtdriver_id', $dr, set_value('txtdriver_id', ($departure->row()->driver_type === '0') ? $departure->row()->driver_id : '-1'), 'id="txtdriver_id" class="form-control select2" weight="100%"'.$_activate); ?>
                        </div>
                     </div>
                     <div class="col-xs-12 col-md-6">
                        <label for="">&nbsp;</label>
                        <div class="input-group">
                           <label for="txt_ctrl_driver_b" class="input-group-addon" title="Candidato a chofer">
                              <input type="radio" id="txt_ctrl_driver_b" name="txt_ctrl_driver" value="1" required <?php if($departure->row()->driver_type === '1'){ echo "checked"; $_activate = ''; } else { $_activate = ' disabled'; } ?>>
                              <i class="fa fa-user"></i>
                           </label>
                           <?php echo form_dropdown('txtdriver_emp_id', $dr_employ, set_value('txtdriver_emp_id', ($departure->row()->driver_type === '1') ? $departure->row()->driver_id : '-1'), 'id="txtdriver_emp_id" class="form-control select2" weight="100%"'.$_activate); ?>
                        </div>
                     </div>
                  </div>
