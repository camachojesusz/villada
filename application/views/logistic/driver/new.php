                     ...
                     <div class="box-body row">
                        <div class="col-xs-12 col-md-4">
                           ...
                           <div class="input-group">
                              ...
                              <input required class="form-control" type="text" id="txtsheetlicence" name="txtsheetlicence" placeholder="folio de licencia" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['sheet_licence'];} ?>">
                           </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
                           ...
                           <div class="input-group">
                              ...
                              <input required class="form-control" type="text" id="txttypelicence" name="txttypelicence" placeholder="licencia tipo" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['type_licence'];} ?>">
                           </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
                     ...
                     <div class="box-body row">
                        <div class="col-xs-12 col-md-4">
                           <div class="form-group">
                              ...
                              <input class="form-control" type="text" id="txtname" name="txtname" placeholder="nombre" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['name'];} ?>" required="">
                           </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
                           <div class="form-group">
                              <label for="txtap1"><sup><li class="fa fa-asterisk color-asterisk-required"></li></sup>Apellido paterno</label>
                              <input class="form-control" type="text" id="txtap1" name="txtap1" placeholder="apellido paterno" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['ap1'];} ?>" required="">
                           </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
                           <div class="form-group">
                              <label for="txtap2"><sup><li class="fa fa-asterisk color-asterisk-required"></li></sup>Apellido materno</label>
                              <input class="form-control" type="text" id="txtap2" name="txtap2" placeholder="apellido materno" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['ap2'];} ?>" required="">
                           </div>
                        </div>
                     </div>
                     <div class="box-footer">
                     ...
                     <div class="box-body row">
                        <div class="col-xs-12 col-md-4">
                           <div class="input-group">
                              ...
                              <input class="form-control" type="tel" maxlength="10" id="txtphone" name="txtphone" placeholder="teléfono" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['phone'];} ?>">
                           </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
                           <div class="input-group">
                              ...
                              <input class="form-control" type="tel" maxlength="10" id="txtcel" name="txtcel" placeholder="celular" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['mobile_phone'];} ?>">
                           </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
                           <div class="input-group">
                              ...
                              <input class="form-control" type="email" id="txtemail" name="txtemail" placeholder="ejemplo@ejemplo.com" value="<?php if (isset($auto_complete) && !empty($auto_complete)){echo $auto_complete['email'];} ?>">
                           </div>
                        </div>
                     </div>
                     <div class="box-footer">
